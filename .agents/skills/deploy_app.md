...
5. **Commit changes**: after each feature got implemented, stage changes and commit changes with user friendly and readable commit message before moving on next feature. Always use "git add ." for staging changes and git commit -m "message" for commit.
